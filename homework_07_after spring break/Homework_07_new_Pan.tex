...
\hypersetup{
  pdftitle={HUDM6026 Homework\_08 In-class Activity},
...
\SpecialCharTok{+}   \CommentTok{\# get the difference in medians, and return the absolute value}
\SpecialCharTok{+}\NormalTok{   test\_out }\OtherTok{\textless{}{-}} \FunctionTok{abs}\NormalTok{(}\FunctionTok{median}\NormalTok{(treat)}\SpecialCharTok{{-}} \FunctionTok{median}\NormalTok{(control))}
...
\NormalTok{[}\DecValTok{1}\NormalTok{] }\FloatTok{4e{-}04}
\end{Highlighting}
\end{Shaded}
