...
\SpecialCharTok{+}     \CommentTok{\# As discussed above, I choose to not use the normalized gradient here}
\SpecialCharTok{+}     \CommentTok{\# gradient\_norm \textless{}{-} gradient\_/sqrt(gradient\_\%*\%gradient\_)}
\SpecialCharTok{+}     \CommentTok{\# {-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}Add the steepest descent{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}{-}}
\SpecialCharTok{+}     \ControlFlowTok{if}\NormalTok{(minimize) \{ f\_min }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(alpha) \{ }
\SpecialCharTok{+}\NormalTok{       p\_temp }\OtherTok{\textless{}{-}}\NormalTok{ p\_old }\SpecialCharTok{{-}}\NormalTok{ alpha}\SpecialCharTok{*}\NormalTok{gradient\_}
\SpecialCharTok{+}       \FunctionTok{f\_original}\NormalTok{(p\_temp[}\DecValTok{1}\NormalTok{], p\_temp[}\DecValTok{2}\NormalTok{]) \} }
\SpecialCharTok{+}\NormalTok{       alpha }\OtherTok{\textless{}{-}} \FunctionTok{optimize}\NormalTok{(f\_min, }\AttributeTok{interval =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{), }\AttributeTok{maximum =} \ConstantTok{FALSE}\NormalTok{)}\SpecialCharTok{$}\NormalTok{minimum }
\SpecialCharTok{+}       \CommentTok{\# update the point coordination with gradient * learning rate}
\SpecialCharTok{+}\NormalTok{       p\_new }\OtherTok{\textless{}{-}}\NormalTok{ p\_old }\SpecialCharTok{{-}}\NormalTok{ alpha}\SpecialCharTok{*}\NormalTok{gradient\_\}}
\SpecialCharTok{+}     \ControlFlowTok{if}\NormalTok{(}\SpecialCharTok{!}\NormalTok{minimize) \{ f\_max }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(alpha) \{ }
\SpecialCharTok{+}\NormalTok{       p\_temp }\OtherTok{\textless{}{-}}\NormalTok{ p\_old }\SpecialCharTok{{-}}\NormalTok{ alpha}\SpecialCharTok{*}\NormalTok{gradient\_}
\SpecialCharTok{+}       \FunctionTok{f\_original}\NormalTok{(p\_temp[}\DecValTok{1}\NormalTok{], p\_temp[}\DecValTok{2}\NormalTok{]) \} }
\SpecialCharTok{+}\NormalTok{       alpha }\OtherTok{\textless{}{-}} \FunctionTok{optimize}\NormalTok{(f\_max, }\AttributeTok{interval =} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{), }\AttributeTok{maximum =} \ConstantTok{TRUE}\NormalTok{)}\SpecialCharTok{$}\NormalTok{maximum }
\SpecialCharTok{+}\NormalTok{       p\_new }\OtherTok{\textless{}{-}}\NormalTok{ p\_old }\SpecialCharTok{{-}}\NormalTok{ alpha}\SpecialCharTok{*}\NormalTok{gradient\_\}}
\SpecialCharTok{+}     \CommentTok{\# check the updating rate of p\_new, if less than epsilong, stop}
\SpecialCharTok{+}\NormalTok{     check }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{((p\_new}\SpecialCharTok{{-}}\NormalTok{p\_old)}\SpecialCharTok{\%*\%}\NormalTok{(p\_new}\SpecialCharTok{{-}}\NormalTok{p\_old))}\SpecialCharTok{/} \FunctionTok{sqrt}\NormalTok{(p\_old }\SpecialCharTok{\%*\%}\NormalTok{ p\_old)}
\SpecialCharTok{+}     \CommentTok{\# redefine the old point to send for next updating }
